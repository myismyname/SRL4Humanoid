...
class RolloutStorage:
    ...
    def __init__(
        ...
        self.pvp_part_size = pvp_part_size
        # Core
        self.observations = torch.zeros(num_transitions_per_env, num_envs, *obs_shape, device=self.device)
        self.pvp_part = torch.zeros(num_transitions_per_env, num_envs, self.pvp_part_size, device=self.device)
    ...
    def add_transitions(self, transition: Transition):
        ...
        self.pvp_part[self.step].copy_(transition.pvp_part)
    ...
    def mini_batch_generator(self, num_mini_batches, num_epochs=8):
        ...
        pvp_part_observations = self.pvp_part.flatten(0, 1)
        ...
        for epoch in range(num_epochs):
            for i in range(num_mini_batches):
                ...
                pvp_part_batch = pvp_part_observations[batch_idx]
                ...
                yield obs_batch, privileged_observations_batch, actions_batch, target_values_batch, advantages_batch, returns_batch, old_actions_log_prob_batch, old_mu_batch, old_sigma_batch, (
                    None,
                    None,
                ), None, rnd_state_batch, {'pvp_part_batch': pvp_part_batch}
